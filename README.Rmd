...
The goal of ShipApp is to visualize on the map the longest distance between two consecutive observations for every ship in given dataset. The app marks points on the map. When clicking a marker user is able to see detailed info about the cruise (i.e. ship name, geocoordinates and sailed distance in meters). Additionally app enables user to filter ships by type and name.   
